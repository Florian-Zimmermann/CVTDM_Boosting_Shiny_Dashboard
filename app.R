...
ui <- fluidPage(
    ...
    # Application title
    titlePanel("Prediction of a customer - Random Forest method"),
        ...
        mainPanel(width = 7, height=5,
          ...
          tabsetPanel(
            ...
            tabPanel("Application information",
                     ...
                     br(),
                     br(),
                     "This prediction is done with the help of a machine learning model, Random Forest, based on a training data set which is visible on another tab of this application. The ideal tuning parameter was found during our analysis and is as follows: mtry = 3. These were used in this application to create the Random Forest and their function is described in our project.",
                     br(),
                     br(),
            ...
            tabPanel("R code",
                     br(),
                     br(),
                     a("GitHub link to the code of this app", href ="https://github.com/Florian-Zimmermann/CVTDM_RF_Shiny_Dashboard"),
                     )
          )
        )
    )
...
# Define server logic required 
  server <- function(input, output) {
    ...
    output$probPlot <-  renderPlot({
      ...
      #Do the prediction
      prob <- predict(rf, client, type = "prob")
